...
// context.
void 
md5::Update (uchar * chInput, uint4 nInputLen) 
{
...
void 
md5::Transform (uchar * block) 
{
  

uint4 a = m_State[0], b = m_State[1], c = m_State[2], d =
...
// a multiple of 4.
void 
md5::Encode (uchar * dest, uint4 * src, uint4 nLength) 
{
...
// a multiple of 4.
void 
md5::Decode (uint4 * dest, uchar * src, uint4 nLength) 
{
